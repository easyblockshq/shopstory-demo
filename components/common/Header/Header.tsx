    ...
    <>
      <div className={styles.wrapper}>
        <div className={styles.leftContainer}>
          <Button onClick={() => setMobileNavOpen(!isMobileNavOpen)}>{isMobileNavOpen ? 'Close' : 'Menu'}</Button>
        </div>
      ...
      <div className={mobileNavMaskclasses.join(' ')} onClick={() => setMobileNavOpen(false)} />
